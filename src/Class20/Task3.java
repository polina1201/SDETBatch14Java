...
class Teacher {
    ...
    Teacher(String name, int age, int yearsOfExperience) { //constructor
        this.name = name;
        this.age = age;
...
class MathTeacher extends Teacher{
    ...
    void teachTheClass(){
        System.out.println("I will teach the class even if the world is going to end right after my class");
    }
